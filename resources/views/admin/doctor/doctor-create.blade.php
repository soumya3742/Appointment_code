        ...
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6 col-lg-6 col-md-6 col-6">
											<label required="required"  class="form-label">Doctor Name *</label>
                                        ...
                                        <div class="form-group col-sm-6 col-lg-6 col-md-6 col-6">
											...
											<select required="required"  class="form-control js-example-basic-multiple" name="education[]" id="education" multiple="multiple">
                                              ...
                                              <option value="D Orth">D Orth</option>
          ...
          <!--                           </div>-->
                                     ...
                                     <div class="form-group col-sm-6 col-lg-6 col-md-6 col-6">
											...
											<select class="form-control " name="system_medicine" id="system_medicine">
                                              ...
                                              <option value="Aayurvedic">Aayurvedic</option>
                                              <option value="Unanai">Unanai</option>
                                              <option value="Yog and Naturopathy">Yog and Naturopathy</option>
                                        ...
                                        <div class="form-group col-sm-6">
											...
											<input type="text"  name="place" id="place_id" class="form-control custom-select">
                                        ...
                                        <div class="form-group col-sm-6 col-lg-6 col-md-6 col-6">
											...
											<input type="alternative_mobile_no" min="10"  class="form-control" name="alternative_mobile_no" id="alternative_mobile_no">
                                        </div>
                                        ...
                                        <div class="form-check-inline">
                                          <label class="form-check-label">
                                            ...
                                            <input type="radio" class="form-check-input" name="our_expert" value="Yes">Yes
                                          </label>
                                        </div>
                                        <div class="form-check-inline">
                                          <label class="form-check-label">
                                            <br /><br />
                                            <input type="radio" class="form-check-input" name="our_expert" checked="checked" value="No">No
                                          </label>
                                        </div>
          ...
          <!--                              </div>-->
                                        ...
                                        <div class="form-group col-sm-6 col-lg-6 col-md-6 col-6">
											...
											<input type="file" class="form-control" name="registration_certificate" id="registration_certificate">
                                        </div>
